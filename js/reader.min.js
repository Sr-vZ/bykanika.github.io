(EPUBJS.reader = {}),
  ...
  (EPUBJS.Reader = function(a, b) {
    ...
    (this.settings = EPUBJS.core.defaults(b || {}, {
      ...
      this.settings.previousLocationCfi &&
        c.gotoCfi(this.settings.previousLocationCfi),
      (this.offline = !1),
      (this.sidebarOpen = !1),
      ...
      c.renderTo("viewer",{method: "continuous", width: "100%", height: "100%"}),
  ...
  (EPUBJS.Reader.prototype.adjustFontSize = function(a) {
    ...
    this.settings.styles &&
      ...
      d &&
        187 == a.keyCode &&
        (a.preventDefault(), this.book.setStyle("fontSize", b + c + "%")),
      d &&
        189 == a.keyCode &&
        (a.preventDefault(), this.book.setStyle("fontSize", b - c + "%")),
      d &&
  ...
  (EPUBJS.Reader.prototype.addBookmark = function(a) {
    this.isBookmarked(a) > -1 ||
      (this.settings.bookmarks.push(a), this.trigger("reader:bookmarked", a));
  }),
  ...
  (EPUBJS.Reader.prototype.isSaved = function(a) {
    return (
      !!localStorage && null !== localStorage.getItem(this.settings.bookKey)
    );
  }),
  ...
  (EPUBJS.Reader.prototype.selectedRange = function(a) {
    var b = new EPUBJS.EpubCFI(),
      c = b.generateCfiFromRangeAnchor(
        a,
        this.book.renderer.currentChapter.cfiBase
      ),
      d = "#" + c;
    this.settings.history &&
      window.location.hash != d &&
      (history.pushState({}, "", d), (this.currentLocationCfi = c));
  }),
  ...
  (EPUBJS.reader.ControlsController = function(a) {
    ...
    return (
      ...
      f.on("click", function() {
        ...
        b.isBookmarked(a) === -1
          ? (b.addBookmark(a),
            f.addClass("icon-bookmark").removeClass("icon-bookmark-empty"))
          : (b.removeBookmark(a),
    ...
    var a = this.book,
      ...
      m = function(c) {
        var d,
          ...
          l = a.renderer.doc;
        if (
          (l.caretPositionFromPoint
            ? ((d = l.caretPositionFromPoint(c.clientX, c.clientY)),
              (g = d.offsetNode),
              (h = d.offset))
            : l.caretRangeFromPoint &&
              ((d = l.caretRangeFromPoint(c.clientX, c.clientY)),
              (g = d.startContainer),
              (h = d.startOffset)),
          3 !== g.nodeType)
        )
        ...
        (h = g.textContent.indexOf(".", h)),
          h === -1 ? (h = g.length) : (h += 1),
          (i = j.generateCfiFromTextNode(
            g,
            h,
            a.renderer.currentChapter.cfiBase
          )),
          (k = { annotatedAt: new Date(), anchor: i, body: e.val() }),
          b.addNote(k),
          n(k),
          o(k),
          e.val(""),
        ...
        var d = a.id,
          e = function() {
            ...
            i[d] ||
              ...
              (b.style.top = l + "px"),
              o > m / 2.5 &&
                ((o = m / 2.5), (pop_content.style.maxHeight = o + "px")),
              popRect.height + l >= m - 25
                ? ((b.style.top = l - popRect.height + "px"),
                  b.classList.add("above"))
                : b.classList.remove("above"),
              k - popRect.width <= 0
                ? ((b.style.left = k + "px"), b.classList.add("left"))
                : b.classList.remove("left"),
              k + popRect.width / 2 >= n
                ? ((b.style.left = k - 300 + "px"),
                  (popRect = b.getBoundingClientRect()),
    ...
    return (
      ...
      h.registerHook(
        ...
        function(a, b) {
          ...
          g.forEach(function(a) {
            if (j.parse(a.anchor).spinePos === c.spinePos)
              try {
                o(a);
              } catch (b) {
  ...
  (EPUBJS.reader.TocController = function(a) {
    var b = this.book,
      ...
      i = function(a) {
        ...
        c.find(".openChapter");
        d.length &&
          (d != f && d.has(e).length > 0 && f.removeClass("currentChapter"),
