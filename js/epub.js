...
(function() {
  ...
  var $$rsvp$events$$default = {
    ...
    on: function(eventName, callback) {
      var allCallbacks = $$rsvp$events$$callbacksFor(this),
        callbacks;
  ...
  function $$$internal$$publish(promise) {
    ...
    if ($$rsvp$config$$config.instrument) {
      $$instrument$$default(
        settled === $$$internal$$FULFILLED ? "fulfilled" : "rejected",
        promise
      );
    }
  ...
  var $$rsvp$node$$default = function denodeify(nodeFunc, options) {
    var fn = function() {
      ...
      args[l] = function(err, val) {
        if (err) $$$internal$$reject(promise, err);
        else if (options === undefined) $$$internal$$resolve(promise, val);
        else if (options === true)
          $$$internal$$resolve(promise, $$rsvp$node$$arrayResult(arguments));
        else if ($$utils$$isArray(options))
          $$$internal$$resolve(
            promise,
            $$rsvp$node$$makeObject(arguments, options)
          );
        else $$$internal$$resolve(promise, val);
      };
  ...
  $$rsvp$all$settled$$AllSettled.prototype = $$utils$$o_create(
    $$enumerator$$default.prototype
  );
  ...
  var $$rsvp$all$settled$$default = function allSettled(entries, label) {
    return new $$rsvp$all$settled$$AllSettled(
      $$rsvp$promise$$default,
      entries,
      label
    ).promise;
  };
  ...
  $$promise$hash$$PromiseHash.prototype = $$utils$$o_create(
    $$enumerator$$default.prototype
  );
  ...
  var $$rsvp$hash$$default = function hash(object, label) {
    return new $$promise$hash$$default($$rsvp$promise$$default, object, label)
      .promise;
  };
  ...
  $$rsvp$hash$settled$$HashSettled.prototype = $$utils$$o_create(
    $$promise$hash$$default.prototype
  );
  ...
  var $$rsvp$hash$settled$$default = function hashSettled(object, label) {
    return new $$rsvp$hash$settled$$HashSettled(
      $$rsvp$promise$$default,
      object,
      label
    ).promise;
...
EPUBJS.core.requestAnimationFrame =
...
EPUBJS.Parser.prototype.packageContents = function(packageXml) {
  ...
  spineNodeIndex = Array.prototype.indexOf.call(
    spineNode.parentNode.childNodes,
    spineNode
  );
...
EPUBJS.Parser.prototype.findNcxPath = function(manifestNode) {
  var node = manifestNode.querySelector(
...
EPUBJS.Parser.prototype.metadata = function(xml) {
  ...
  metadata.modified_date = p.querySelectorText(
    xml,
    "meta[property='dcterms:modified']"
  );
  metadata.layout = p.querySelectorText(
    xml,
    "meta[property='rendition:layout']"
  );
  metadata.orientation = p.querySelectorText(
    xml,
    "meta[property='rendition:orientation']"
  );
  metadata.spread = p.querySelectorText(
    xml,
...
EPUBJS.EpubCFI.prototype.generateChapterComponent = function(
  _spineNodeIndex,
  _pos,
  id
) {
...
EPUBJS.EpubCFI.prototype.generateCfiFromTextNode = function(
  anchor,
  offset,
  base
) {
  ...
  return (
    "epubcfi(" + base + "!" + path + "/" + index + ":" + (offset || 0) + ")"
  );
};
...
EPUBJS.Spine.prototype.get = function(target) {
  ...
  if (this.epubcfi.isCfiString(target)) {
    ...
    target &&
    (typeof target === "number" || isNaN(target) === false)
  ) {
    index = target;
    ...
    epubPackage = this.request(this.containerUrl)
      ...
      .then(function(paths) {
        ...
        if (packageUri.origin) {
          ...
          location = EPUBJS.core.uri(window.location.href);
          book.url = EPUBJS.core.resolveUrl(
            location.base,
            _url + packageUri.directory
          );
        } else {
      ...
      .catch(function(error) {
        ...
        console.error(
          "Could not load book at: " + (this.packageUrl || this.containerPath)
        );
...
EPUBJS.View.prototype.render = function(_request) {
  ...
  return this.section.render(_request).then(
    function(contents) {
...
EPUBJS.Layout.Reflowable.prototype.calculate = function(
  _width,
  _height,
  _gap,
  _devisor
...
EPUBJS.Rendition.prototype.attachListeners = function() {
  ...
  if (
    !EPUBJS.core.isNumber(this.settings.width) ||
...
EPUBJS.Rendition.prototype._display = function(target) {
  ...
  if (visible) {
    ...
    displayed = this.moveTo(offset).then(function() {
      return this.check();
    });
  } else {
...
EPUBJS.Rendition.prototype.parseLayoutProperties = function(_metadata) {
  ...
  var layout =
    (this.layoutOveride && this.layoutOveride.layout) ||
    metadata.layout ||
    "reflowable";
  var spread =
    (this.layoutOveride && this.layoutOveride.spread) ||
    metadata.spread ||
    "auto";
  var orientation =
    (this.layoutOveride && this.layoutOveride.orientation) ||
...
EPUBJS.Rendition.prototype.isVisible = function(
  view,
  offsetPrev,
  offsetNext,
  _container
...
EPUBJS.Paginate.prototype.currentLocation = function() {
  ...
  if (visible.length > 1) {
    ...
    startB =
      container.left +
      this.layout.spread -
      visible[visible.length - 1].position().left;
